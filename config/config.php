 ...
 */
$GLOBALS['BE_MOD']['content']['jeu_concours'] =  array
			(
			    'tables'       	=> array('tl_xkn_jeu_concours'),
    			'icon'         	=> 'system/modules/xkn_mkg_attributes/html/imgs/icon.gif'
			);
...
array_insert($GLOBALS['FE_MOD']['miscellaneous'], 0, array  
	(  
	    'jeu_concours' => 'ModuleJeuConcours',  
	    'jeu_concours_info' => 'ModuleJeuConcoursInfo'  
	));
